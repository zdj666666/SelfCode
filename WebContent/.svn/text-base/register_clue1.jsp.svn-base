...
<%String cancel = request.getAttribute("cancel").toString(); %>
...
<!-- <div class="modal fade" id="myModalLoading" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="z-index:0;">
 -->			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<%if(cancel !=null){ %>
							<button type="button" class="btn btn-default" data-dismiss="modal" onclick="Return()">取消</button>
						<%}else{ %>
