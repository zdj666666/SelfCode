...
+function()
{
	...
	function Bubble()
	{
		...
		for(var i=0; i<4; i++)
		{
			...
			{
				if(_IE6_)
					sty.filter = "progid:DXImageTransform.Microsoft.AlphaImageLoader(src=images/no1.png)";
				else
					sty.backgroundImage = "url(images/no1.png)";
				break;
			}
			...
			{
				sty.filter = "alpha progid:DXImageTransform.Microsoft.AlphaImageLoader(src=images/no1.png)";
